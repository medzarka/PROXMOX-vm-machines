...
vm_creation_steps(){
    ...
    load_vm_data $VMID $VM_DATA $VM_AUTOGENERATED_DATA 
...
load_vm_data(){
    ...
    echo "#### TEST #### Read DATA list"
    echo "---------------------"
    echo "#### TEST #### the content of DATA list is "${DATA[@]}""
    echo "---------------------"
    ...
    do
        ...
        then
            ...
            echo "$DATA_VALUE" | sudo tee -a ".env/$A_DATA" > /dev/null
        fi
    done

    echo "#### TEST #### Read AUTOGENERATED_DATA list"
    echo "#### TEST #### the content of DATA list is "${AUTOGENERATED_DATA[@]}""
